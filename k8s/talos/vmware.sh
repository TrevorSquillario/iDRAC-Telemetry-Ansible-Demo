...
WORKER_DATA_DISK=${WORKER_DATA_DISK:=40G}
...
create_worker() {
    ...
    # Add secondary data disk 
    govc vm.disk.create -vm ${CLUSTER_NAME}-worker-${i} -name ${CLUSTER_NAME}-worker-${i}/disk-1000-1 -size ${WORKER_DATA_DISK}
